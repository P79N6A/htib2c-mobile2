    ...
    public String toInvoiceOrderInfo() {
        ...
        if (validateParentOrderEntryInput()) {
            ...
            if (parentrderinfo == null  || childorders.size() == 0 || Strings.isNullOrEmpty(parentrderinfo.getOrderStatus())) {
                applyInvoicePop = "请确认您的订单号是否准确。如需帮助，请按车内【i】按钮<br/>或致电<span style=\"text-decoration: underline;\" class=\"span2\">400-898-0050</span>";
                context.addMessage(null, new FacesMessage(
            ...
            if(!parentrderinfo.getOrderStatus().equalsIgnoreCase(Constant.DB_ORDER_STATUS_COMPLETED)) {
                applyInvoicePop = "订单尚未完成，请稍后再试。如需帮助，请按车内【i】按钮或致电<span style=\"text-decoration: underline;\" class=\"span2\">400-898-0050</span>";
                context.addMessage(null, new FacesMessage(
...
//                        FacesMessage.SEVERITY_ERROR, "无法获知您的智能互联客户编号。请点击菜单“在线订购”-> “我的账户”进行登录之后再试。如需帮助，请按车内【i】按钮或致电4008980050", ""));
            ...
            if(!Strings.isNullOrEmpty(accountNum) && !accountNum.equalsIgnoreCase(parentrderinfo.getAccountNum())) {
                applyInvoicePop = "请点击菜单“我的账户”->“我的账户”请成功登录完成该订单所用账号后进行发票申请。 如需帮助，请按车内【i】按钮或致电<span style=\"text-decoration: underline;\" class=\"span2\">400-898-0050</span>。";
//                context.addMessage(null, new FacesMessage(
//                        FacesMessage.SEVERITY_ERROR, "您的智能互联客户编号与订单所属的客户编号不符。请点击菜单“在线订购”-> “我的账户”进行登录之后再试。如需帮助，请按车内【i】按钮或致电4008980050", ""));
                context.addMessage(null, new FacesMessage(
                        FacesMessage.SEVERITY_ERROR, "请点击菜单“我的账户”->“我的账户”登录成功后进行发票申请。 如需帮助，请按车内【i】按钮或致电400-898-0050。", ""));
                return ViewPage.LINK2ApplyInvoice;
            }
            ...
            if (invoiceInfoRequest.getOrderNum() != null) {
                ...
                try {
                    ...
                    if (dateDiff > 30) {
                        applyInvoicePop = "您的订单已超出发票申请期限。请在订单支付完成后的30天之内提交发票开具申请。 <br/>如需帮助，请按车内【i】按钮或致电<span style=\"text-decoration: underline;\" class=\"span2\">400-898-0050</span>。";
                        context.addMessage(null, new FacesMessage(
