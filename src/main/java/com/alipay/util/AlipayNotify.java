...
public class AlipayNotify {
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
        ...
        if(AlipayConfig.sign_type.equals("0001")){
        	isSign = RSA.verify(preSignStr, sign, ConfigureInfo.getAlipayPaymentPublicKey(), AlipayConfig.input_charset);
        }
        return isSign;
    }
    ...
    * false 请检查防火墙或者是服务器阻止端口问题以及验证时间是否超过一分钟
    */
    /*2017-10-25;Alex:优化代码质量，将IO流等关闭;CR-代码规范*/
    private static String checkUrl(String urlvalue) {
        ...
        try {
            ...
            ipStream = urlConnection.getInputStream();
            ip_reader = new InputStreamReader(ipStream);
            bf_reader = new BufferedReader(ip_reader);
            inputLine = bf_reader.readLine().toString();
        } catch (Exception e) {
            e.printStackTrace();
            inputLine = "";
        }finally{
