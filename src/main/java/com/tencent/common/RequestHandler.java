...
public class RequestHandler {
	...
	/** 商户参数 */
	private String appid = ConfigureInfo.getWechatAppid();
	private String appkey;
	private String partnerkey = ConfigureInfo.getWechatPartnerKey();
	private String appsecret = ConfigureInfo.getWechatAppSecret();
	private String key = ConfigureInfo.getWechatPartnerKey();
	/** 请求的参数 */
