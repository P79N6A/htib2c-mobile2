...
public class DownloadBillBusiness {
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener) throws Exception {
        ...
        log.i("api请求总耗时：" + ESAPI.encoder().encodeForHTML(ESAPI.encoder().encodeForHTML(totalTimeCost+"")) + "ms");

        log.i(ESAPI.encoder().encodeForHTML(downloadBillServiceResponseString));
